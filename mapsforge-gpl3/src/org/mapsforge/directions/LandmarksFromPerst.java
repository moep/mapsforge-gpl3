...
public class LandmarksFromPerst {
	...
	/**
	 * This function checks if {@link GeoCoordinate} t is on one side or the other of a line formed by
	 * the first two parameters.
	 * 
	 * It is used at the core of the function which checks if a {@link GeoCoordinate} is inside a
	 * rectangle.
	 * 
	 * @param p1
