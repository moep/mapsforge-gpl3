...
/**
 * Turn by turn directions contain a way which was found by a routing algorithm. Streets which are of
 * them same name are concatenated, except in case of a U-turn. Street lengths and angles between
 * streets are calculated and saved.
 * 
...
public class TurnByTurnDescription {
	...
	/**
	 * Constructs a TurnByTurnDirectionsObject from an array of IEdges as the are provided by the
	 * IRouter
	 * 
	 * @param routeEdges
